...
const validateCheck = function (checkbox) {
    if (!checkbox.checked) {
...
const samePassword = function (password, repeatPassword) {
...
const validate = input => {
    ...
    switch (input.type) {
        ...
        case 'password':
            return input.id !== 'password2' ? validatePassword(input) : samePassword(password, password2)
        case 'checkbox':
